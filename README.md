# Aplikasi Aplikasi Tol Enterprise

ðx¢ Sistem Tol Enterprise - World-Class Enterprise v5.0
...
## Entities
- **Data Utama**: Judul, Kategori, Nilai (Rp), Status
- **Transaksi Pembayaran**: No. Invoice, Deskripsi, Total (Rp), Metode Bayar, Status
